  ...
  return (
    <section className="bg-[#1a1a1a] py-14 px-6">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="flex md:grid md:grid-cols-5 gap-3 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory md:snap-none scrollbar-hide goals-slider">
          {GOALS.map((g) => (
            <div
              key={g.label}
              className="goal-card relative rounded-lg overflow-hidden aspect-[3/4] cursor-pointer min-w-[45%] md:min-w-0 flex-shrink-0 snap-start "
            >
              <img
                src={g.img}
                alt={g.label}
