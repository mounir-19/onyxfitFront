  ...
  const onFinish = async (e) => {
    ...
    try {
      ...
      if (response.data && response.data.user) {
        ...
        alert(`Account created successfully! Logged in as ${userData.email}`);
        onNavigate("home");
      }
    } catch (err) {
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-zinc-900 border border-zinc-700 text-white rounded-lg focus:outline-none focus:border-red-500 transition-colors"
                  placeholder="Doe"
                  required
                  minLength={2}
                />
